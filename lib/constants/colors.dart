...
class AppColors {
  ...
  static const Map<String, Color> appColor = const <String, Color>{
    'orangeMain': Color.fromRGBO(250, 74, 12, 1),
    'appBackground': Color.fromRGBO(242, 242, 242, 1),
    'greyMain': Color.fromRGBO(123, 117, 115, 1)
  };
}
