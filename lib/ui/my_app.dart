...
class MyApp extends StatelessWidget {
  ...
  final RecipeListStore _recipeStore = getIt<RecipeListStore>();
  final FoodStore _foodStore = getIt<FoodStore>();
  final CartStore _cartStore = getIt<CartStore>();
  final OrderStore _orderStore = getIt<OrderStore>();
  final MyFoodStore _myFoodStore = getIt<MyFoodStore>();
  @override
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        Provider<RecipeListStore>(create: (_) => _recipeStore),
        Provider<FoodStore>(create: (_) => _foodStore),
        Provider<CartStore>(create: (_) => _cartStore),
        Provider<OrderStore>(create: (_) => _orderStore),
        Provider<MyFoodStore>(create: (_) => _myFoodStore),
      ],
      child: Observer(
